...
(struct vinbero_common_Module* module, struct vinbero_common_ClData* clData, int major); \
\
int \
vinbero_interface_HTTP_onRequestVersionMinor \
(struct vinbero_common_Module* module, vinbero_common_ClData* clData, int minor); \
\
int \
