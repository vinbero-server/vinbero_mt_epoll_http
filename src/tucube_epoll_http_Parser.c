...
static inline void tucube_epoll_http_Parser_prepareForNextToken(struct tucube_epoll_http_Parser* parser) {
    parser->tokenOffset = 0;                                                                                                                                                     
    parser->token = parser->buffer + parser->bufferOffset;                                                                                                                       
}

static inline void tucube_epoll_http_Parser_compactBuffer(struct tucube_epoll_http_Parser* parser) {
